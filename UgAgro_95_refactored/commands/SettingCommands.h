 ...
 *
 * @tparam T Тип значения настройки (float, bool, uint8_t, uint32_t, int, и т.д.)
 */
template<typename T>
...
/**
 * @brief Команда для String
 */
class StringCommand : public SettingCommand<String> {
public:
  StringCommand(const char* cmdName, String& setting)
    : SettingCommand<String>(cmdName, setting, nullptr) {}
};
